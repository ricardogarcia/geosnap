...
/**
 *  # geosnap
 *  geosnap ![geosnap](https://cloud.githubusercontent.com/assets/1282364/11599365/1a1c39d2-9a8c-11e5-8819-bc1e48b30525.png)
 */
...
/**
 * ## States
 * geosnap explicitly defines initial state
 *
 */
 ...
 *
 * ## Initial state
 * Create instances for the keys of each structure in geosnap
...
export default function native (platform) {
  let Geosnap = React.createClass({
    render () {
      const store = configureStore(getInitialState())

            // configureStore will combine reducers from geosnap and main application
